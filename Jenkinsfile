pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/allame'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamioh-allame/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('allame-225')                                                         //<------your MiamiID
    }
